...
save('saves/save1.txt','saves/save1inv.txt',me.y)
me.y.weapon,me.y.name,me.y.wallet,me.y.skill, me.y.invent = load('saves/save1.txt','saves/save1inv.txt',me)
...
def save(saveto, invsave, sprite): #sprite is the player
	f = open(saveto, 'r+')
	f.write(sprite.name)
	f.write('\n')
	f.write(sprite.weapon.name) #use weaponlist?
	f.write('\n')
...
def load(loadfrom, loadfrominv, sprite):
	f = open(loadfrom, 'r')
